...
export const FETCH_USERADVERTS_REQUEST = 'FETCH_USERADVERTS_REQUEST'
export const FETCH_USERADVERTS_FAILURE = 'FETCH_USERADVERTS_FAILURE'
export const FETCH_USERADVERTS_SUCCESS = 'FETCH_USERADVERTS_SUCCESS'
